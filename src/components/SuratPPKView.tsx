        ...
        {filteredList.length === 0 ? (
          ...
          filteredList.map((item) => (
            ...
            >
              ...
              <div>
                <div className="flex items-center justify-between">
                  <span className="font-mono font-black text-sm text-teal-950 tracking-tight break-all">
                    {item.nomorSurat}
                  </span>
                  <button
                    onClick={() => copyToClipboard(item.nomorSurat, item.id)}
                    className="p-1 text-slate-400 hover:text-teal-600 rounded-md shrink-0 ml-2"
                ...
                {item.tujuan && (
                  <div className="mt-2 text-[11px] text-slate-600 bg-slate-50 rounded-xl p-2.5 border border-slate-100">
                    <span className="text-slate-400 font-medium">Alamat / Rekanan: </span>
              ...
              <div className="pt-2 border-t border-slate-100 flex items-center justify-between gap-2">
                <button
                  onClick={() => copyToClipboard(item.nomorSurat, item.id)}
                  className="flex-1 py-1.5 bg-teal-50 hover:bg-teal-100 text-teal-800 rounded-xl font-bold text-xs flex items-center justify-center gap-1.5 transition-colors border border-teal-200"
                >
